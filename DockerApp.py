...
def run():
    try:
        ...
        print("""Name for container in use 
or Image not exists!""")
        return None
...
def remove():
    try:
        ...
        print("No such container: test to remove")
...
def start():
    try:
        ...
        print("No such container: test to start")
...
def stop():
    try:
        ...
        print("No such container: test to stop")
...
def push():
    try:
        ...
        print("Resource ID was not provided")
    except docker.errors.NotFound:
        print("Image to push not found")
